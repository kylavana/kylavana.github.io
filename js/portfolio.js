...
app.controller('portfolioController', function ($scope) {
  $scope.portfolioItems = [
    ...
    },
    {
      ...
      image:'port_bday.jpg',
      desc:"A web-based booklet celebrating the 1-year anniversary of Affiliated Engineers, Inc.'s new knowledge sharing platform (nick-named FiL). The booklet features a user driven page-turning effect (only on desktops) and animation to help bring the illustrations to life. The illsutrations were drawn with Adobe Illustrator, and animated by css.",
    ...
    },
    {
      ...
      image:'port_comic.jpg',
      desc:"This illustration was drawn for Affiliated Engineers, Inc. and shows how waste products are used in the creation of a renewable energy source. I used a comic book style to make the complex process more accessible to a non-technical audience.",
     link:'no',//set to no to hide
      link_class:'',
      link_txt:'',
    },
